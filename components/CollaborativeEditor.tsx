...
import SharedRulesPanel from "./SharedRulesPanel";
  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        >
          {/* Intent Panel - 3/4 height */}
          <div className="flex-[3] border-b overflow-hidden min-h-0">
            <IntentPanel
              blocks={intentBlocks}
